    ...
    <div className=" rounded-lg p-2 min-h-screen">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
        {pending.map((provider) => (
          <div
            key={provider.id}
            className="border border-gray-200  bg-white rounded-t-lg"
            style={{
              width: "358.67px",
              height: "420px",
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <div>
                <p
                  className="text-gray-600 mt-5 ml-5 mb-3"
                  style={{
                    width: "200px",
                    height: "20px",
                    lineHeight: "20px",
                ...
                <p
                  className="text-gray-500 ml-5 mb-4"
                  style={{
                    width: "200.67px",
                    height: "22px",
                    lineHeight: "20px",
