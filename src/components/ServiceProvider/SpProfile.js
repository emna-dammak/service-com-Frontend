...
const SpProfile = () => {
  ...
  useEffect(() => {
    const fetchServiceProvider = async () => {
      try {
        const response = await fetch(`${API_URL}user/service-providers/${id}`, {
          method: "GET",
          headers: {
        ...
        setProvider(data[0]);
        const serviceIds = data[0]?.skills
          ?.split(", ")
        ...
        if (serviceIds?.length) {
          ...
          const servicesData = await Promise.all(
            serviceResponses.map((res) => res.json())
          );
    ...
    <div className="rounded-lg font-sans min-h-screen">
      ...
      >
        <div
          style={{
            width: "47%",
            backgroundColor: "rgba(231, 240, 233, 0.8)",
            border: "2px solid rgba(63, 106, 73, 0.8)",
            borderRadius: "10px",
          }}
        >
          <div className="flex justify-left mb-1">
            <p
              className=" ml-5 mt-9 mb-4  "
              style={{
                width: "300px",
                height: "20px",
                lineHeight: "20px",
          ...
          <div className="flex items-start mt-6 mb-5">
            <div className="ml-5">
              <p
                className="text-gray-800 mb-10 mt-5"
                style={{
                  width: "270px",
                  height: "20px",
                  lineHeight: "20px",
              ...
              >
                ...
                <span className="text-gray-700">
                  ...
                  <img
                    src="/star.svg"
                    alt="icon1"
                    className="inline-block w-6 mb-2 ml-1"
                  />
                </span>
              </p>
            </div>
            ...
            <div className="ml-5">
              <p
                ...
                style={{
                  ...
                  fontFamily: "Arial",
                  fontWeight: "bold",
                  color: "rgba(8, 81, 15, 0.8)",
                }}
              >
                Services :
              </p>
              {provider.skills &&
                provider.skills.split(", ").map((skill) => {
              ...
              >
                <div className="pt-4">
                  <img
                    ...
                    alt={service.title}
                    className="w-80 h-56 object-cover mb-4 mx-auto mx-auto rounded"
                  />
                </div>
