...
const ServiceProviderList = () => {
  ...
  useEffect(() => {
    const fetchServiceProviders = async () => {
      try {
        const response = await fetch(`${API_URL}user/service-providers`, {
          method: "GET",
          headers: {
  ...
  return (
    <div className="rounded-lg p-6 pt-8 pb-8 mb-4 font-sans">
      <h2
        className="text-xl font-medium font-sans mb-4 text-gray-600 text-center bg-transparent"
        style={{
          fontSize: "24px",
          width: "1128px",
          height: "36px",
          ...
          >
            ...
            <div className="flex justify-center mt-4">
              <Link
                ...
                className="text-white font-bold py-2 px-1 flex items-center mr-3"
                style={{
                  borderRadius: "5px",
                  width: "155px",
                  height: "38px",
                  boxShadow: "0px 2px 4px 0px rgba(165, 163, 174, 0.3)",
                  background: "rgba(99, 196, 116, 1)",
                }}
              >
