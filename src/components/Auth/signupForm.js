    ...
    try {
      ...
      if (response.ok) {
        if (isServiceProvider) {
          ...
          const response2 = await fetch(`${API_URL}user/login`, {
            method: "POST",
            headers: {
          ...
          if (response2.ok) {
            ...
            if (cvFile) {
              ...
              const response3 = await fetch(`${API_URL}user/cv`, {
                method: "PATCH",
                credentials: "include",
  ...
  return (
    <div className="flex flex-col h-full ">
      ...
      <div className="flex flex-col mt-8 items-center w-full pr-6 pb-10 h-[90%] overflow-scroll scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 overflow-x-hidden">
        <div>
          <h2 className="text-3xl font-bold text-[#263238] mt-4 mb-8 self-start">
            Sign Up
          </h2>
        </div>
        <form onSubmit={handleSubmit} className="w-full flex-col">
          <div className="flex flex-wrap -mx-2 mb-4">
            <div className="w-full md:w-1/2 px-2 mb-4 md:mb-0">
              <label htmlFor="firstName" className="block mb-2 text-[#263238]">
                First Name
              </label>
              <input
                id="firstName"
            ...
            <div className="w-full md:w-1/2 px-2">
              <label htmlFor="lastName" className="block mb-2 text-[#263238]">
                Last Name
              </label>
              <input
                id="lastName"
          ...
          <div className="flex flex-wrap -mx-2 mb-4">
            <div className="w-full md:w-1/2 px-2 mb-4 md:mb-0">
              <label
                htmlFor="governorate"
                className="block mb-2 text-[#263238]"
              >
                Governorate
              </label>
              <input
            ...
            <div className="w-full md:w-1/2 px-2">
              <label htmlFor="delegation" className="block mb-2 text-[#263238]">
                Delegation
              </label>
              <input
                id="delegation"
          ...
          <div className="mb-4 mt-6">
            <label
              ...
              className="flex items-center text-[#263238]"
            >
              <input
          ...
          <div className=" text-red-500 w-full h-[4vh] mt-4">
            {errorMessage ?? null}
          </div>
